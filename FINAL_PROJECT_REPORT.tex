...
\usepackage{ragged2e}%
%
\title{Human Activity Recognition with Smartphone Sensors}%
...
\item%
Flutter/Dart {-} Mobile frontend for data collection%
\item%
...
\label{subsec:AdditionalPerformanceMetrics}%
\vspace{0.3cm}%


\begin{figure}[H]%
\begin{subfigure}[t]{0.49\textwidth}%
\includegraphics[width=\linewidth]{confusion_matrix_norm.png}%
\caption{Normalized confusion matrix showing classification probabilities.}%
\end{subfigure}%
\hfill%
\begin{subfigure}[t]{0.49\textwidth}%
\includegraphics[width=\linewidth]{f1_scores_bar.png}%
\caption{F1{-}scores by activity class for baseline and fine{-}tuned models.}%
\end{subfigure}%
\\%
\vspace{0.5cm}%
\begin{subfigure}[b]{0.75\textwidth}%
\centering%
\includegraphics[width=\linewidth]{plots/no_stairs_rf_cm.png}%
\caption{Random Forest confusion matrix after removing Upstairs/Downstairs classes.}%
\end{subfigure}%
\caption{Additional performance metrics: (a) Normalized confusion matrix, (b) F1{-}scores, and (c) 4{-}class confusion matrix.}%
\end{figure}
